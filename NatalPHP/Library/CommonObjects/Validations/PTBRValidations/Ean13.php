...
use NatalPHP\CommonObjects\Validations\Ean13 as Ean13EN;
require_once dirname(__DIR__) . '/Ean13.php';
/* SVN FILE: $Id$ */
/**
 * 
 *
...
class Ean13 extends Ean13EN{

    public function getDefaultMessage($var, $label, $value, $gender) {
        return 'O EAN-13 informado não é válido';
    }
}
