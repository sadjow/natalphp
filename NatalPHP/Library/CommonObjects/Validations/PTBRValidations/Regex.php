...
use NatalPHP\CommonObjects\Validations\Regex as RegexEN;
require_once dirname(__DIR__) . '/Regex.php';
/* SVN FILE: $Id$ */
/**
 * 
 *
...
class Regex extends RegexEN{

    public function getDefaultMessage($var, $label, $value, $gender) {
        $artigo = $gender == 'm' ? 'o' : 'a';
        return "'$value' não é um valor válido para $artigo $label";
    }
}
