...
use NatalPHP\CommonObjects\Validations\LessThan;
require_once dirname(__DIR__) . '/LessThan.php';
/* SVN FILE: $Id$ */
/**
 *
 *
...
class MenorQue extends LessThan {


    public function getDefaultMessage($var, $label, $value, $gender) {
        $artigo = $gender == 'm' ? 'o' : 'a';
        $str    = $this->equals ? 'ou igual a ' : 'que ';
        return strtoupper($artigo) .  " $label deve ser menor $str" . $this->value;
    }
}
