...
use NatalPHP\CommonObjects\Validations\MinSize;
require_once dirname(__DIR__) . '/MinSize.php';
/* SVN FILE: $Id$ */
/**
 * 
 *
...
class TamanhoMinimo extends MinSize {

     public function getDefaultMessage($var, $label, $value, $gender) {
        $artigo = $gender == 'm' ? 'O' : 'A';
        return "$artigo $label deve ter tamanho maior ou igual a {$this->max}";
    }
}
