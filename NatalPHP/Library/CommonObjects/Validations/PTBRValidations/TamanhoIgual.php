...
use NatalPHP\CommonObjects\Validations\SizeEquals;
require_once dirname(__DIR__) . '/SizeEquals.php';
/* SVN FILE: $Id$ */
/**
 * 
 *
...
class TamanhoIgual extends SizeEquals {

    public function getDefaultMessage($var, $label, $value, $gender) {
       $artigo = $gender == 'm' ? 'o' : 'a';
       return "$artigo $label deve ter o tamanho igual a {$this->size}";
    }
}
