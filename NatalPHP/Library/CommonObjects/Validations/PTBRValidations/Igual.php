...
use NatalPHP\CommonObjects\Validations\Equals;
require_once dirname(__DIR__) . '/Equals.php';
/* SVN FILE: $Id$ */
/**
 * 
 *
...
class Igual extends Equals {

    public function getDefaultMessage($var, $label, $value, $gender) {
        $artigo = $gender == 'm' ? 'o' : 'a';
        return strtoupper($artigo) .  " $label deve ser igual a " . $this->value;        
    }
