...
use NatalPHP\CommonObjects\Validations\InSet;
require_once dirname(__DIR__) . '/InSet.php';
/* SVN FILE: $Id$ */
/**
 * 
 *
...
class NoConjunto extends InSet {


    public function getDefaultMessage($var, $label, $value, $gender) {
        return "$label deve ser um destes valores: " . implode(', ', $this->set);
    }
}
