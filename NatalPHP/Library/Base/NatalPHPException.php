<?php
namespace NatalPHP\Base;

/* SVN FILE: $Id: NatalPHPException.php 52 2010-01-10 22:32:35Z Sadjow $ */
/**
 * NatalPHPException class file.
 *
...
require_once __DIR__ . '/NatalPhpObject.php';

/**
 * Base exception class.
 * 
 * @package       NatalPHP
 * @subpackage    NatalPHP.NatalPHP.Base
 */
class NatalPHPException extends \Exception implements NatalPHPObject {
